...
//	CD3DX12_RESOURCE_DESC resourceDesc = CD3DX12_RESOURCE_DESC::Buffer((sizeof(Worldmatrix) + 0xff) & ~0xff);
//
//
...
//	printf("結果9: %s (0x%08X)\n", HResultToString(result), result);
//	*mapMatrix = Worldmatrix;//行列の内容をコピー
//
...
//	//rootparam[1].DescriptorTable.NumDescriptorRanges = 1;//ディスクリプタレン次数
...
//		//cbvHandle.ptr += _dev->GetDescriptorHandleIncrementSize(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
//		//_cmdList->SetGraphicsRootDescriptorTable(1, cbvHandle);
//
//		// バックバッファインデックス取得
